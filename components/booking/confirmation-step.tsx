    ...
    <section aria-labelledby="confirmation-heading" className="mx-auto max-w-3xl">
      <div className="rounded-[1.5rem] border border-line bg-white p-6 text-center shadow-card sm:p-10">
        ...
        <div className="mt-8 grid gap-4 text-left sm:grid-cols-2">
          <div className="rounded-xl bg-background p-4"><p className="text-xs font-semibold uppercase tracking-[0.12em] text-muted">Booking ID</p><p className="mt-2 font-bold text-foreground">{booking.bookingId}</p><p className="mt-1 text-sm font-semibold text-success">{booking.status === "confirmed" ? "Confirmed" : booking.status}</p></div>
